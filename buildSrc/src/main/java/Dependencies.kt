...
object Dependencies {
    ...
    const val hiltWorkManager = "androidx.hilt:hilt-work:1.0.0-alpha01"
    ...
    const val insetter = "dev.chrisbanes:insetter:0.3.0"
    const val insetterKtx = "dev.chrisbanes:insetter-ktx:0.3.0"
