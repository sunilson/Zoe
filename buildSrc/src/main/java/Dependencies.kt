...
object Deps {
    ...
    const val hiltKapt = "com.google.dagger:hilt-compiler:$HILT_VERSION"
    const val hiltKaptJetpack = "androidx.hilt:hilt-compiler:1.0.0"
    ...
    const val insetter = "dev.chrisbanes.insetter:insetter:0.5.0"
    ...
    const val moshixSealedRuntime = "dev.zacsweers.moshix:moshi-sealed-runtime:0.22.1"
    const val moshixAdapters = "dev.zacsweers.moshix:moshi-adapters:0.22.1"
    const val moshixSealedCodegen = "dev.zacsweers.moshix:moshi-sealed-codegen:0.22.1"
